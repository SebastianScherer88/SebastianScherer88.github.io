...
# loading data
football_grounds_data <- data.table::fread('C:/Users/bettmensch/Documents/Coursera/developing_data_products/week_4/european_grounds_data.csv',
                  data.table = FALSE) %>%
...
frankfurt_icon <- leaflet::makeIcon(
  'C:/Users/bettmensch/Documents/Coursera/developing_data_products/week_4/frankfurt_badge.png',
  iconWidth = 50,
  iconHeight = 50,
  iconAnchorX = 50/2,
  iconAnchorY = 50/2
...
wimbledon_icon <- leaflet::makeIcon(
  'C:/Users/bettmensch/Documents/Coursera/developing_data_products/week_4/afc_wimbledon_badge.png',
  iconWidth = 44,
  iconHeight = 50,
  iconAnchorX = 44/2,
  iconAnchorY = 50/2
